...
os.system(f'python cli.py -b tests/sources/shum.mp3 -o {FINAL_RENDER} -a tests/sources/demo.png --shade_path tests/sources/Shadow.png -t 1 -ot 1 -ut 1 -un LOUISDIOO -tn Шумодав --overlay_opacity 0.8')
